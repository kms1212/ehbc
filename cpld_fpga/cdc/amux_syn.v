...
//lpm_mux DEVICE_FAMILY="FLEX6000" LPM_SIZE=2 LPM_WIDTH=12 LPM_WIDTHS=1 data result sel
...
`endif
	...
	assign
		...
		sel_node = {sel[0]},
		w_data102w = {data[20], data[8]},
		w_data114w = {data[21], data[9]},
		w_data126w = {data[22], data[10]},
		w_data138w = {data[23], data[11]},
		w_data18w = {data[13], data[1]},
		w_data30w = {data[14], data[2]},
		w_data42w = {data[15], data[3]},
		w_data4w = {data[12], data[0]},
		w_data54w = {data[16], data[4]},
		w_data66w = {data[17], data[5]},
		w_data78w = {data[18], data[6]},
		w_data90w = {data[19], data[7]};
endmodule //amux_mux
//VALID FILE
...
module amux (
	...
	wire [11:0] sub_wire0;
	wire [11:0] sub_wire5 = data0x[11:0];
